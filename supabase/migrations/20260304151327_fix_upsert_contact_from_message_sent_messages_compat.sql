/*
  # Fix upsert_contact_from_message for sent_messages compatibility

  The function references NEW.phone_number but sent_messages table does not have
  that column. This fix makes the function check the table name before accessing
  phone_number, using only NEW.numero for sent_messages.
*/
